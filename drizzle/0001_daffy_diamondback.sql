...
END $$;
--> statement-breakpoint
CREATE UNIQUE INDEX IF NOT EXISTS "collaborators_workspace_id_user_id_index" ON "collaborators" ("workspace_id","user_id");--> statement-breakpoint
CREATE UNIQUE INDEX IF NOT EXISTS "workspaces_slug_index" ON "workspaces" ("slug");