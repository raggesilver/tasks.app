...
ALTER TABLE "status_columns" ADD COLUMN "workspace_id" uuid;--> statement-breakpoint
DO $$ BEGIN
...
END $$;
--> statement-breakpoint
CREATE UNIQUE INDEX IF NOT EXISTS "boards_workspace_id_name_index" ON "boards" USING btree ("workspace_id","name");--> statement-breakpoint
CREATE UNIQUE INDEX IF NOT EXISTS "status_columns_board_id_order_index" ON "status_columns" USING btree ("board_id","order");